# File for player connecting to pacman and playing as the red ghost
...
if __name__ == '__main__':
	...
	reactor.connectTCP('student02.cse.nd.edu', 8679, commandFactory) #command port number on pacman host for red ghost
