...
class pinkGhost(pygame.sprite.Sprite):
	...
	def __init__(self, gs=None):
		...
		self.count = 0
		self.l = ["pinkGhost",self.rect,self.image]
...
if __name__ == '__main__':
	...
	reactor.connectTCP('student02.cse.nd.edu', 8680, commandFactory) #command port number
